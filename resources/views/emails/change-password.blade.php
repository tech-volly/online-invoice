        ...
        <tbody>
            ...
            <tr>
                <td align="left">
                    ...
                    <p style="font-size: 16px;font-weight: 500; line-height: 22px; margin-top: 15px;">If you’re having trouble clicking the "Reset Password" button, copy and paste the URL below into your web browser.</p>
                    <a href="{{$details['resetUrl']}}">{{$details['resetUrl']}}</a>  
                </td>
            </tr>
            <tr style="display: inline-block;">
                <td> 
                    <a href="{{$details['resetUrl']}}" onMouseOver="this.style.backgroundColor='#2d7e65'"onMouseOut="this.style.backgroundColor='#44b994'" style="text-decoration: none; color: #fff; border-radius: 5px; font-weight: 500;
                    display: inline-block; font-weight: 400; line-height: 22px; transition: color .15s ease-in-out, background-color .15s ease-in-out, border-color .15s ease-in-out, box-shadow .15s ease-in-out;
                        background: #44b994; padding: 10px 30px; font-weight: 500; font-size: 16px; text-transform: uppercase;">Reset Password</a>
                </td>
            </tr>
        </tbody>
    </table>
