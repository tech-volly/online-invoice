        ...
        <tbody>
            ...
            <tr>
                <td align="left">
                    ...
                    <p style="font-size: 16px;font-weight: 500; line-height: 22px; margin-top: 15px;">Thank you for your business.</p>  
                    <p style="font-size: 16px;font-weight: 500; line-height: 22px; margin-top: 15px;">Please find the invoice attached from HDS. If you have any queries, please do not hesitate to contact us on 1300 100 437.</p>    
                </td>
            </tr>
            <tr>
                <td align="left">
