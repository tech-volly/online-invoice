...
@component('components.breadcrumb')                
    @slot('title') {{ $data->id > 0 ? ($readonly == 'readonly' ? 'View' : 'Edit') : 'Add' }} Invoice @endslot
    @slot('li_1') Dashboard @endslot
    @slot('li_2') Invoices @endslot
    @slot('li_3') {{ $data->id > 0 ? ($readonly == 'readonly' ? 'View' : 'Edit') : 'Add' }} Invoice @endslot
@endcomponent

@include('layout.flash-message')
<form action="{{route('invoices.add.action')}}" method="post" id="addEditInvoice">
    @csrf
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">Invoice Details</h4>
                </div>
                <div class="card-body">
                    @if($data->id > 0)
                    <div class="row">
                        <div class="col-xl-6">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    ...
                                    name="invoice_number" id="invoice_number" value="{{$data->invoice_number}}" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-xl-6">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <select class="form-control client_list" name="client_id" id="client_id" {{$readonly == 'readonly' ? 'disabled' : ''}}>
                                        <option selected disabled>Select Client</option>
                                        @foreach($clients as $client)
                                            <option value="{{$client->id}}" 
                                                {{$data->client_id === $client->id ? 'selected' : ''}}
                                                data-client="{{$client->client_number}}" >
                    ...
                    <div class="row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <div class="cal-icon">
                                        ...
                                        value="{{$data->invoice_date ? getDateDisplayFormat($data->invoice_date) : 
                                            getDateDisplayFormat($dt->toDateString())}}" 
                                        {{$readonly}}>
									</div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-6">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" name="invoice_payment_terms" id="invoice_payment_terms" 
                                    value="{{$data->id > 0 ? $data->invoice_payment_terms : 7}}" {{$readonly}}>
                                </div>
                            </div>
                        </div>                      
                    </div>
                    <div class="row">
                        <div class="col-xl-6">
                            <div class="form-group row">
                                <label class="col-lg-3 col-form-label">Invoice Due Date</label>
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" name="invoice_due_date" id="invoice_due_date" 
                                    value="{{$data->invoice_due_date ? getDateDisplayFormat($data->invoice_due_date) : ''}}" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-6">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <select class="form-control brand_list" name="brand_id" id="brand_id" {{$readonly == 'readonly' ? 'disabled' : ''}}>
                    ...
                    <div class="row">
                        <div class="col-xl-6">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" name="invoice_po_number" id="invoice_po_number" 
                                    value="{{$data->invoice_po_number}}" {{$readonly}}>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-6">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <div class="cal-icon">
										<input class="form-control floating invoiceDatetimepicker" type="text" 
                                        name="invoice_payment_date" id="invoice_payment_date" value="{{$data->invoice_payment_date ? getDateDisplayFormat($data->invoice_payment_date) : ''}}" {{$readonly}}>
									</div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-xl-6">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <textarea rows="7" cols="5" class="form-control" name="invoice_notes" id="invoice_notes" {{$readonly}}>{{$data->invoice_notes}}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-6">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <textarea rows="7" cols="5" class="form-control" name="invoice_emails" id="invoice_emails" {{$readonly}}>{{$data->invoice_emails}}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xl-6">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" name="invoice_discount" id="invoice_discount" 
                                    value="{{$data->invoice_discount}}" {{$readonly}}>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-6">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                <select class="form-control project_list" name="project_id" id="project_id" {{$readonly}}>
                                        <option  value="" {{$data->project_id ? '' : "selected"}}>Select Project</option>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered mb-0" id="invoiceProductTable">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                @if($data->invoice_payments->count() > 0)
                                    @foreach($data->invoice_payments as $invoice_payment)
                                    <tr id="productRow_1">
                                        <input type="hidden" name="invoice_payment_id[]" value="{{@$invoice_payment->id}}">
                                        <td>
                                            <select class="form-select product_id" name="product_id" id="product_id"  {{$readonly == 'readonly' ? 'disabled' : ''}}>
                                                <option selected disabled>Select Product</option>
                                                @foreach($products as $product)
                                                    <option value="{{$product->id}}" {{$invoice_payment->product_id === $product->id ? 'selected' : ''}}>
                                        ...
                                        <td>
                                            <textarea rows="2" name="product_description" id="product_description" class="form-control" {{$readonly}}>{{$invoice_payment->product_description}}</textarea>
                                        ...
                                        <td>
                                            ...
                                            value="{{$invoice_payment->product_unit_price}}" {{$readonly}}>
                                            <input type="hidden" name="hidden_prod_unit_price[]" id="hidden_prod_unit_price">
                                        </td>
                                        <td>
                                            <select class="form-select tax_selection" name="tax_selection" id="tax_selection" {{$readonly == 'readonly' ? 'disabled' : ''}}>
                                                <option selected disabled>Select Tax</option>
                                                <option value="GST Inclusive" {{$invoice_payment->tax_selection == 'GST Inclusive' ? 'selected' : ''}}>
                                                    GST Inclusive
                                                </option>
                                                <option value="GST" {{$invoice_payment->tax_selection == 'GST' ? 'selected' : ''}}>
                                                    GST
                                                </option>
                                                <option value="No GST" {{$invoice_payment->tax_selection == 'No GST' ? 'selected' : ''}}>No GST</option>
                                            </select>
                                        ...
                                        <td>
                                            ...
                                            value="{{$invoice_payment->product_quantity}}" {{$readonly}}>
                                        ...
                                        <td>
                                            ...
                                            value="$ {{$invoice_payment->product_subtotal}}" readonly data-discount=0>
                                        ...
                                        <td>
                                            ...
                                            value="$ {{$invoice_payment->product_gst}}" readonly data-gst=0>
                                        ...
                                        <td>
                                            ...
                                            value="$ {{$invoice_payment->product_grand_total}}">
                                    ...
                                    <input type="hidden" name="another_id[]" value="{{@$invoice_payment->id}}">
                                    @endforeach
                                @else
                        ...
                        <table class="table table-bordered invoice-table" id="invoiceTotalTable">
                        ...
                        <input type="hidden" name="invoice_grand_item_total" id="invoice_grand_item_total">
                        <input type="hidden" name="invoice_grand_gst" id="invoice_grand_gst">
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="form-group row">
                <label class="col-lg-3 col-form-label">Invoice Notes</label>
                <div class="col-lg-12">
                    <textarea name="invoice_master_notes" id="invoice_master_notes" class="ckeditor form-control" rows="5">
                        {!! $data->id > 0 ? ($data->invoice_master_notes ? $data->invoice_master_notes : $invoice_setting->invoice_footer_notes) : $invoice_setting->invoice_footer_notes !!}
                    </textarea>
                </div>
            </div>
        </div>
    ...
    <div class="text-center">
        ...
        @endif
        <a href="{{route('invoices')}}" class="btn btn-dark">Cancel</a>
    </div>
</form>
...
@endsection
@section('script')
<script src="{{ URL::asset('public/assets/js/pages/invoice-payment.js')}}"></script>
