...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::get('dashboard/client-revenue/export', [DashboardController::class, 'exportClientRevenueReport'])->name('dashboard.client-revenue.export');
    ...
    Route::group(['prefix' => 'products'], function () {
        ...
        Route::get('/get-data', [ProductController::class, 'getProducts'])->name('products.get-data');
    });
    ...
    Route::group(['prefix' => 'expected-expenses'], function () {
        ...
        Route::get('/get-data', [ExpectedExpenseController::class, 'getExpectedExpenses'])->name('expected-expenses.get-data');
    });
    ...
    Route::group(['prefix' => 'invoices'], function () {
        ...
        // Add BEFORE your resource route for invoices
        Route::get('/get-data', [InvoiceController::class, 'getInvoices'])->name('invoices.get-data');
        Route::post('/cancel/{id}', [InvoiceController::class, 'cancelInvoice'])->name('invoices.cancel-invoice');
    });
    ...
    Route::group(['prefix' => 'quotes'], function () {
        ...
        Route::get('/get-data', [QuoteController::class, 'getQuotes'])->name('quotes.get-data');
        ...
        Route::get('/generate-invoice/{id}', [QuoteController::class, 'generateInvoice'])->name('quote.generate-invoice');
    });
    ...
    Route::group(['prefix' => 'reports'], function () {
        ...
        Route::get('/client-statement', [ReportController::class, 'clientStatement'])->name('reports.client-statement');
    });
